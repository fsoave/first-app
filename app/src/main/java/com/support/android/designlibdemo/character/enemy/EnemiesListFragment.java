...
public class EnemiesListFragment extends Fragment {

    private List<MiniCharacter2> characters;
    ...
    /*private void initializeData(){
        ...
        List<String> list = getList(Enemies.sEnemiesStrings);
        while (i < list.size()) {
            characters.add(new MiniCharacter2(list.get(i)));
            i++;
        }
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new SimpleStringRecyclerViewAdapter(getActivity(),
                getList(Enemies.sEnemiesStrings)));
                // mettere tutte le var con i nomi nella stessa classe
    }
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("character_type", "enemy");
                    context.startActivity(intent);
                }
            });

            Glide.with(holder.mImageView.getContext())
                    .load(Enemies.getRandomDrawable())
                    .fitCenter()

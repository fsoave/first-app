...
import com.support.android.designlibdemo.character.specop.SpecOp;
 ...
 */
public class CovertDetailActivity extends AppCompatActivity {
    ...
    private void loadBackdrop() {
        ...
        Glide.with(this).load(SpecOp.getRandomDrawable()).centerCrop().into(imageView);
    }

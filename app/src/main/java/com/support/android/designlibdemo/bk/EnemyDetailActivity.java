package com.support.android.designlibdemo.bk;
...
import com.support.android.designlibdemo.character.enemy.Enemies;
...
public class EnemyDetailActivity extends AppCompatActivity {
    ...
    private void loadBackdrop() {
        ...
        //questa carica l'immagine di sfondo --> mem nome immagine personaggio nel db
        Glide.with(this).load(Enemies.getRandomDrawable()).centerCrop().into(imageView);
    }
